...
const NAV_LINKS = ["Home", "About", "Services", "Portfolio", "Videos", "Testimonials", "Contact"];
...
const GALLERY = [
  ...
  {
    src: "https://images.unsplash.com/photo-1537633552985-df8429e8048b?w=600&h=750&fit=crop&auto=format",
    alt: "Romantic pre-wedding outdoors",
    category: "Pre-Wedding",
  },
  {
    src: "https://images.unsplash.com/photo-1529634806980-85c3dd6d34ac?w=600&h=750&fit=crop&auto=format",
...
export default function Home() {
  ...
  const filters = ["All", "Wedding", "Pre-Wedding", "Couple", "Kids", "Maternity"];
  ...
  return (
    <div className="min-h-screen bg-background text-foreground" style={{ fontFamily: "'Jost', sans-serif" }}>
      ...
      <section id="home" className="relative overflow-hidden bg-background min-h-[88vh] flex flex-col items-center justify-center">
        <div className="absolute inset-0 pointer-events-none" style={{ background: "radial-gradient(ellipse 70% 60% at 50% 40%, rgba(45,90,61,0.06) 0%, transparent 70%), radial-gradient(ellipse at 0% 100%, rgba(45,90,61,0.07) 0%, transparent 50%), radial-gradient(ellipse at 100% 0%, rgba(45,90,61,0.05) 0%, transparent 50%)" }} />
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-6 py-16">
          <img src={logo} alt="Sathya Photography" className="h-48 md:h-64 w-auto object-contain mb-8" />
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            <button
              ...
              className="flex items-center gap-3 bg-primary text-primary-foreground px-8 py-4 text-xs tracking-[0.25em] uppercase hover:bg-accent transition-colors duration-300"
            >
              Let"s Capture Your Story <ArrowUpRight size={14} />
            </button>
            <button
              onClick={() => navigate("/portfolio")}
              className="flex items-center gap-3 border border-primary/30 text-primary px-8 py-4 text-xs tracking-[0.25em] uppercase hover:border-primary hover:bg-primary/5 transition-all duration-300"
            >
              View Portfolio
            </button>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-16 md:gap-24 items-center">
          <div className="relative">
            <div className="aspect-[4/5] overflow-hidden bg-card">
              <img src={aboutPhoto} alt="Sathya — Photographer & Videographer" className="w-full h-full object-cover object-top" />
            </div>
          ...
          <div>
            ...
            <h3 className="text-2xl md:text-3xl text-primary mb-6 tracking-wide" style={{ fontFamily: "'Cormorant Garamond', serif", fontStyle: "italic" }}>Photography & Videography Studio</h3>

            <div className="space-y-4 text-muted-foreground font-light leading-relaxed text-sm md:text-base">
              <p>
                Since 2000, Sathya Photography has been Ongole's most trusted name in professional photography and videography. Over two decades of craft, dedication, and thousands of stories told through the lens have made this studio the first choice for families, couples, and businesses across Andhra Pradesh.
              </p>
              <p>
                We provide the finest wedding photography, cinematic videography, pre-wedding shoots, engagement sessions, maternity portraits, and kids photography — not just in Ongole, but across Guntur, Vijayawada, and Hyderabad. Every frame is composed with intention, every edit is finished with care.
              </p>
              <p>
                What sets Sathya Photography apart is a deep commitment to authentic storytelling. We don't manufacture moments — we find them. Whether it's the quiet glance between a couple during the ceremony, the joy on a child's face, or the golden light falling on a new mother, our job is to be ready when life is at its most beautiful.
              </p>
            </div>
            ...
            <blockquote className="mt-6 pl-4 border-l-2 border-accent italic text-accent text-sm font-light" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
              "A photograph is not just an image — it is the story of a feeling that cannot be put into words."
            </blockquote>
      ...
      <section id="portfolio" className="py-24 md:py-36 px-6 md:px-12 max-w-7xl mx-auto">
        ...
        <div className="flex justify-center mt-12">
          <button
            onClick={() => navigate("/portfolio")}
            className="flex items-center gap-3 bg-primary text-primary-foreground px-10 py-4 text-xs tracking-[0.25em] uppercase hover:bg-accent transition-colors duration-300"
          >
      ...
      <section id="videos" className="py-24 md:py-32 bg-[#1a3828]">
        <div className="px-6 md:px-12 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[1, 2, 3, 4].map((n) => (
              <div key={n} className="relative group overflow-hidden rounded-xl bg-[#0f2318] aspect-[9/16] sm:aspect-video flex items-center justify-center border border-[#f5efe3]/10">
            ...
            <div className="space-y-5">
              ...
              <div className="flex items-start gap-4 text-sm text-muted-foreground">
                ...
                <p className="leading-relaxed">
                  Opp: Sai Saroj Mayuri Theatre,<br />
                  Vamsi Complex, Shop No. 5,<br />
            ...
            {[
              ...
              <div key={key}>
                ...
                <input
                  ...
                  className="w-full bg-transparent border-b border-border focus:border-primary outline-none py-3 text-foreground text-sm placeholder:text-muted-foreground/40 transition-colors duration-300"
                />
              </div>
            ))}
            <div>
